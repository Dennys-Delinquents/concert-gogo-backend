...
async function getEvents(request, response, next) {
  try {
    ...
    let url = `https://app.ticketmaster.com/discovery/v2/events.json?classificationName=music&stateCode=FL&apikey=${process.env.API_KEY}`
...
class Events {
  constructor(eventsObj) {
    ...
    // this.startTime = eventsObj.dateTime;
